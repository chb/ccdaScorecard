...
Component.cleanupStep(Cleanup.clearNulls,2);
...
var SimpleCode = function(oid){
  return Component.define("SimpleCode")
  .cleanupStep(function(){
    console.log("Making a SC", oid, this.js);
...
.containingChildTemplate("2.16.840.1.113883.10.20.22.4.53")
.uriBuilder({
  category:"entries",
  type:"immunizationsRefused"
});
...
.fields([
  ...
  ["immunizationsRefused","0..*", RefusedImmunization.xpath(), RefusedImmunization],
])
.uriBuilder({
  category: "sections",
  type: "immunizations"
...
.cleanupStep(function(){
  ...
  var range = this.js.times.filter(function(t){
    return -1 === ['PIVL_TS', 'EIVL_TS'].indexOf(t.xsitype);
  });
