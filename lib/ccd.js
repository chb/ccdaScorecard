...
MedicationActivity.planned = "("+MedicationActivity.templateXpath()+")" + "[@moodCode='INT']"
MedicationActivity.administered = "("+MedicationActivity.templateXpath()+")" + "[@moodCode='EVN']"

var PlannedMedication = MedicationActivity.
   define("PlannedMedication")
  .uriBuilder({
    category:"entries",
    type:"plannedMedications"
  });

var MedicationsSection = Component.define("MedicationsSection")
  .templateRoot(["2.16.840.1.113883.10.20.22.2.1",
                 "2.16.840.1.113883.10.20.22.2.1.1"])
  .fields([
            //["name","0..1", "h:code", ConceptDescriptor],
            ["administered","0..*", MedicationActivity.administered, MedicationActivity],
            ["planned","0..*", MedicationActivity.administered, PlannedMedication],
    ])
  .uriBuilder({
    category: "sections",
    type: "medications"
  ...
  .fields([
        //    ["sourceIds", "1..*", "h:id", Identifier],
         ...
         //   ["results", "0..1", ResultsSection.templateXpath(), ResultsSection],
           ["medications", "0..1", MedicationsSection.templateXpath(), MedicationsSection],
